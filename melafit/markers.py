...
def amplitude(values: np.ndarray[np.float64]) -> np.float64:
    """
...
def midpoint(times: np.ndarray[np.float64],
             values: np.ndarray[np.float64],
             thresh_rel: np.float64
             ) -> tuple[np.float64, np.float64, np.float64, np.float64]:
    """
    Comput melatonin midpoint, DLMOn and DLMOff times
    ...
    -------
        result : tuple[float, float, float, float]
            Meladonin midpoint, DLMOn and DLMOff times (from 0.0 to 1.0,
